...
export type GetBorrowHistoryQuery = {
  ...
  reserves: Array<{
    ...
    borrowHistory: Array<{
      __typename?: 'Borrow';
      timestamp: number;
      reserve: { __typename?: 'Reserve'; variableBorrowRate: string };
    }>;
  }>;
};

export type GetSupplyHistoryQueryVariables = Exact<{
  id: Scalars['ID'];
  from: Scalars['Int'];
  to: Scalars['Int'];
}>;

export type GetSupplyHistoryQuery = {
  __typename?: 'Query';
  reserves: Array<{
    __typename?: 'Reserve';
    id: string;
    ...
    supplyHistory: Array<{
      __typename?: 'Supply';
      timestamp: number;
      reserve: { __typename?: 'Reserve'; liquidityRate: string };
    }>;
  }>;
};

export const GetBorrowHistoryDocument = gql`
  query getBorrowHistory($id: ID!, $from: Int!, $to: Int!) {
    reserves(
      where: {
        id: $id
        borrowHistory_: { timestamp_gt: $from, timestamp_lt: $to }
      }
    ) {
      id
      symbol
...
export type GetBorrowHistoryQueryResult = Apollo.QueryResult<
  ...
  GetBorrowHistoryQueryVariables
>;
export const GetSupplyHistoryDocument = gql`
  query getSupplyHistory($id: ID!, $from: Int!, $to: Int!) {
    reserves(
      where: {
        id: $id
        supplyHistory_: { timestamp_gt: $from, timestamp_lt: $to }
      }
    ) {
      id
      symbol
...
/**
 * __useGetSupplyHistoryQuery__
 *
 * To run a query within a React component, call `useGetSupplyHistoryQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetSupplyHistoryQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetSupplyHistoryQuery({
 *   variables: {
 *      id: // value for 'id'
 *      from: // value for 'from'
 *      to: // value for 'to'
 ...
 * });
 */
export function useGetSupplyHistoryQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetSupplyHistoryQuery,
    GetSupplyHistoryQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetSupplyHistoryQuery, GetSupplyHistoryQueryVariables>(
    GetSupplyHistoryDocument,
    options,
  );
}
export function useGetSupplyHistoryLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetSupplyHistoryQuery,
    GetSupplyHistoryQueryVariables
  >,
  ...
  return Apollo.useLazyQuery<
    GetSupplyHistoryQuery,
    GetSupplyHistoryQueryVariables
  >(GetSupplyHistoryDocument, options);
}
export type GetSupplyHistoryQueryHookResult = ReturnType<
  typeof useGetSupplyHistoryQuery
>;
export type GetSupplyHistoryLazyQueryHookResult = ReturnType<
  typeof useGetSupplyHistoryLazyQuery
>;
export type GetSupplyHistoryQueryResult = Apollo.QueryResult<
  GetSupplyHistoryQuery,
  GetSupplyHistoryQueryVariables
>;
